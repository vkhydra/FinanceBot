...
public interface IFinanceOperationsService
{
    ...
    Task<OrcamentoMensalDto> ObterOrcamentoMensalAsync(int? ano = null, int? mes = null, CancellationToken cancellationToken = default);
    Task<OrcamentoMensalDto> AtualizarOrcamentoMensalAsync(AtualizarOrcamentoMensalRequest request, CancellationToken cancellationToken = default);
