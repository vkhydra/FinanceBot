        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoVinculo = table.Column<string>(type: "character varying(6)", maxLength: 6, nullable: true),
                    VinculoExpiracao = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Receitas_UsuarioId_Data",
                table: "Receitas",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Usuarios_CodigoVinculo",
                table: "Usuarios",
                column: "CodigoVinculo",
                unique: true);
